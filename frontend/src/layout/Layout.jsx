...
export const Layout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/chat', label: 'Recruiter Chat', icon: '💬' },
    { path: '/executive', label: 'Executive', icon: 'EI' },
    { path: '/insights', label: 'Insights', icon: 'IN' },
    { path: '/reports', label: 'Reports', icon: 'RP' },
    { path: '/explainability', label: 'Explainability', icon: 'XA' },
    { path: '/audit', label: 'Audit Logs', icon: 'AL' },
    { path: '/graph', label: 'Graph Trace', icon: 'GT' },
    { path: '/prompts', label: 'Prompts', icon: 'PI' },
